                                        ...
                                        <div class="product-item">
                                            <div class="thumbnail">
                                                <a href="productDetails?id=${phproduct.product.id}">
                                                    <img style="width: 200px;height: 200px;" src="upfile/${phproduct.product.filename}" alt="multi-purpose">
                                                </a>
                                            </div>
                                            <div class="info">
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="productDetails?id=${product.id}">
                                                <img style="width: 200px;height: 200px;" src="upfile/${product.filename}" alt="Product Images">
                                            </a>
                                        </div>
